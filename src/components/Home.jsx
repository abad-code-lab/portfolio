                        ...
                        <div className="md:w-1/2 text-left">
                            ...
                            <div className="flex items-center gap-4 text-slate-600">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <a href="https://www.linkedin.com/in/abdoulaye-daffe-38b82a266" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center hover:border-primary-400 hover:text-primary-600 transition-colors text-slate-400 hover:bg-slate-50">
                                        <Linkedin size={18} />
                                    </a>
